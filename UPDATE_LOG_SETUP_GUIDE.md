...
<<<<<<< HEAD
### Bước 3: Lấy URL Google Sheets để đếm lượt tải về (Download Tracker)
1. Mở file Google Sheets trực tuyến (bảng lưu câu trả lời mà bạn đã tạo ở Bước 1).
2. Nhấp nút **Share (Chia sẻ)** ở góc trên bên phải.
3. Tại phần *General Access (Quyền truy cập chung)*, chuyển từ **Restricted (Bị hạn chế)** sang **Anyone with the link (Bất kỳ ai có đường liên kết)** với quyền là **Viewer (Người xem)**.
4. Nhấn **Copy link (Sao chép đường liên kết)**.
5. Trong Unity, dán link này vào ô **Google Sheet Url** trong bảng Inspector của `FeedbackSystem`.
